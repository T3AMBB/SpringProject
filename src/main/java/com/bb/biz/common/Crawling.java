	...
	public void sample () {
      ...
      while(itr1.hasNext()) {
         ...
         while(itr5.hasNext()) {
            ...
            System.out.println("상세2: "+detail2);
            ...
            if(-1!=detail2.lastIndexOf("재질")) {
               ...
               try {
                  ...
                  out = new FileOutputStream("D:\\06007LIM\\image\\"+n+".png"); // out 객체에 저장경로(저장을 원하는 위치) 입력
                  n++;
                  while(true) {
                  ...
                  vo2.setPname(title2);
                  vo2.setPimg(img2);
                  vo2.setPdetail(detail2);
                  vo2.setPrice(price4);
                  vo2.setPcnt(10);
                  System.out.println(vo2);
                 productService.insert(vo2);
