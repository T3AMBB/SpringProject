      ...
      <div class="container">
        <div class="form_txtInput">
 		<form action="signUp.do" method="post">
          ...
          <p class="exTxt">네이버 계정을 사용하기 위한 추가 회원가입을 진행합니다.</p>
          <div class="join_form">
            <table>
              <colgroup>
                <col width="30%"/>
              ...
              <tbody>
                <tr>
                  <th><span>아이디</span></th>
                  <td class="row"><input type="text" placeholder="ID 를 입력하세요." id="mid" name="mid" value="${naver.mid}" readonly="readonly"></td>
                </tr>
                <tr>
                  <th><span>이름</span></th>
                  <td class="row"><input type="text" placeholder="이름을 입력해주세요." id="mname" name="mname"  value="${naver.mname}" readonly="readonly"></td>
                </tr>
                <tr>
          ...
          <div class="btn_wrap2">
          <input type="hidden" name="mpw" value="${naver.mpw}">
